...
public slots:
    ...
    void clickedButton(const QString &company, const QString &hr, const QString &emailid, const QString &address, const QString &phoneno, const QString &password, const QString &vnumber, const QString &vmodel);
