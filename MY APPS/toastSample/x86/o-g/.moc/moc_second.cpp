/****************************************************************************
** Meta object code from reading C++ file 'second.hpp'
**
...
#include "../../../src/second.hpp"
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'second.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_controller[] = {
    "controller\0\0double\0no1,no2\0addbtn(int,int)\0"
};
...
void controller::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { double _r = _t->addbtn((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
